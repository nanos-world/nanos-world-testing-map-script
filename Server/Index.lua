testing_map_spawns = {
	...
	Prop(Vector(-2126, 6365, 133), Rotator(0, -11.250048, 0), "NanosWorld::SM_Crate_01"),
	...
	Prop(Vector(-3824, 8045, 198), Rotator(0, 19.687542, 0), "NanosWorld::SM_PlierSet_01"),
	Prop(Vector(-3759, 8057, 198), Rotator(0, -14.062580, 0), "NanosWorld::SM_PliersSet_07"),
	Prop(Vector(-4730, 6813, 141), Rotator(), "NanosWorld::SM_RoundStand.SM_RoundStand"),
	Prop(Vector(-4736, 6812, 203.631), Rotator(), "NanosWorld::SM_Saw_01"),
	...
	Prop(Vector(-1403, 4845, 199.600), Rotator(0, -45031, 0), "NanosWorld::SM_Crate_Lid_01"),
	Prop(Vector(-5933, 8163, 183), Rotator(), "NanosWorld::SM_Toolbox_01"),
	Prop(Vector(-5929, 8126, 229.931), Rotator(), "NanosWorld::SM_Toolbox_06"),
	Prop(Vector(-5932, 8178, 230), Rotator(), "NanosWorld::SM_VaseA"),
	Prop(Vector(-1034, 5557, 235), Rotator(), "NanosWorld::KitchenWare/SM_CupD"),
	Prop(Vector(8352, -3766, 157.045), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8497, -3766, 152.638), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8636, -3766, 152.638), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8775, -3766, 152.654), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8916, -3766, 156.766), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8430, -3766, 260.385), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8575, -3766, 255.978), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8714, -3766, 255.994), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8853, -3766, 260.107), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8506, -3766, 361.318), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8645, -3766, 361.334), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8784, -3766, 365.447), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8571, -3766, 472.659), Rotator(), "NanosWorld::SM_Cube_02"),
	Prop(Vector(8710, -3766, 472.674), Rotator(), "NanosWorld::SM_Cube_02"),
